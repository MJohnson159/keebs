...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_DVORAK] = LAYOUT_kc (
     ...
     LSFT,SCLN, Q  , J  , K  , X  ,LOWR,     RASE, B  , M  , W  , V  , Z  ,RSFT,
                       LALT,BSLT,LGUI,         SPC ,ENT ,LCTL
  ),

  [_LOWER] = LAYOUT_kc (
     F11 , F1 , F2 , F3 , F4 , F5 ,                F6 , F7 , F8 , F9 ,F10 ,F12 ,
     TILD,____,____, UP ,____,____,               RHUI,RHUD,RSAI,RSAD,RVAI,RVAD,
     CAPS,____,LEFT,DOWN,RGHT,HOME,               PGUP,UNDS,PLUS,LCBR,RCBR,____,
     BL_S,____,MUTE,VOLD,VOLU,END ,____,     ____,PGDN,MPRV,MPLY,MNXT,____,____,
                       LCTL,DEL ,RMOD,         RTOG,INS ,____
  ),
  ...
  [_GAMING] = LAYOUT_kc (
     ...
     ESC , A  , S  , D  , F  , G  ,                H  , J  , K  , L  ,SCLN,QUOT,
     LSFT, Z  , X  , C  , V  , B  ,LOWR,     RASE, N  , M  ,COMM,DOT ,SLSH,RSFT,
                       LCTL,LALT ,SPC ,         SPC ,ENT ,LALT
  ),

  [_ADJUST] = LAYOUT_kc (
     F11 , F1 , F2 , F3 , F4 , F5 ,                F6 , F7 , F8 , F9 ,F10 ,F12 ,
     ____,RST ,____,____,____,____,               ____,____,____,____,____,____,
     ____,____,____,____,____,____,               ____,QWRT,CLMK,DVRK,GMNG,____,
